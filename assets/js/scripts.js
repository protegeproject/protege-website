(function($) {
  ...
  if (navigator.appVersion.indexOf("Win")!=-1) {
    ...
    $('.desktop-download-btn').attr('href', 'http://protege.stanford.edu/download/protege/5.0/binaries/protege-5.0.0-beta-12.zip');
  ...
  if (navigator.userAgent.indexOf("Linux")!=-1) {
    ...
    $('.desktop-download-btn').attr('href', 'http://protege.stanford.edu/download/protege/5.0/binaries/protege-5.0.0-beta-12.tar.gz')
